...
def schedule_rooms(comb,intervals, all_days,total_rooms_ids, capacities_room, data_optimization,dct_rooms_caps,buffer_between_meetings=0,   max_shifted_hours=1, percent_meetings_allowed_for_rescheduling = 0.1, penatly_coefficient=1, rescheduling=False, plot=True): 
...
def schedule_rooms2(comb,intervals, all_days,total_rooms_ids, capacities_room, equipments_room, data_optimization,dct_rooms_caps,dct_rooms_eq, buffer_between_meetings=0,   max_shifted_hours=1, percent_meetings_allowed_for_rescheduling = 0.1, penatly_coefficient=1, rescheduling=False, plot=True): 
